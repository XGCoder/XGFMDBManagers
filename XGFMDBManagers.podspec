#
#  Be sure to run `pod spec lint XGFMDBManagers.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "赵小嘎" => "email@address.com" }
  # Or just: s.author    = "赵小嘎"
  # s.authors            = { "赵小嘎" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/赵小嘎"
